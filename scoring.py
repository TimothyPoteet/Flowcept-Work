...
# BUILD LLM
def build_llm_model(model_name=None, temperature=0.01, top_p=1.0, max_tokens=500):
    if model_name is None:
        ...
        return SambaStudio(model_kwargs=model_kwargs)
    else:
        os.environ["OPENAI_API_KEY"] = "?"
        from langchain_openai import ChatOpenAI
        return ChatOpenAI(model=model_name, temperature=temperature)

llm = build_llm_model(model_name="gpt-4o", temperature=0.00,top_p=1.0)
# L_SCORE PROMPT
